...
# the list is passed by reference! Hence, if you modify it within the function, the modification will be applied everywhere
...
def search_element_2(target, l_input):
    ...
    l_internal = l_input   # l_internal will refer to the same object id. Hence, when we modify l_internal, we also modify l_input
    l_internal.sort()
